                ...
                <div id="button2">
                    <div class="col">
                        <a href="admission.php?student=2_2" id="student">
                            <center>
                            นักเรียนชั้น<br>มัธยมศึกษา
                            ปีที่ 4 <br>ประเภทนักเรียนทั่วไป
                            </center>
                        </a>
                    </div>
                </div>
            ...
            <form action="add_data.php" method="get">
                <div class="row" id="button_row_2">
                    ...
                    <div class="col-10">
                        ...
                        <div class="col-3" id="row1" style="text-align:right">คำนำหน้าชื่อ : 
                            </div>
...
<div class="row" id="data4">
                    ...
                    <div class="row" id="data4">
                        ...
                        <div class="container" id="data_phone1">
                        <div class="row" id="data4">
                            <div class="col-3" style="text-align:  right">
                                ที่อยู่บ้านเลขที่
                            </div>
                            <div class="col-2">
                                <input class="form-control" style="width:100%" type="text" name="home_no" id="home_no" required>
                            </div>
                            <div class="col-1" style="">
                                หมู่ที่
                            </div>
                            <div class="col-2">
                                <input class="form-control" style="width:100%" type="text" name="group_no" id="group_no" required>
                            </div>
                            <div class="col-1" style="">
                                บ้าน
                            </div>
                            <div class="col-3">
                                <input class="form-control" style="width:100%" type="text" name="home" id="home" required>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row" id="data4">
                            ...
                            <div class="col-2">
                                <input class="form-control" style="width:100%" type="text" name="sub_area" id="sub_area" required>
                            </div>
                            <div class="col-1" style="">
                                อำเภอ
                            </div>
                            <div class="col-2">
                                <input class="form-control" style="width:100%" type="text" name="area" id="area" required>
                            </div>
                            <div class="col-1" style="">
                                จังหวัด
                            </div>
                            <div class="col-3">
                                <input class="form-control" style="width:100%" type="text" name="province" id="province" required>
                            </div>
                        </div>
                        ...
                        <div class="col-2">
                            <input class="form-control" style="width:100%" type="text" name="post" id="post" required pattern="[0-9]{5}">
                        </div> </div>
                        </div>
                        ...
                        <div class="row" id="data4">
                            ...
                            <div class="col">
                                <input class="form-control" style="width: 100%" type="text" name="father_name" id="father_name" required>
                            </div>
                        </div>
                        ...
                        <div class="row" id="data4">
                            ...
                            <div class="col">
                                <input class="form-control" style="width: 100%" type="text" name="mother_name" id="mother_name" required>
                            </div>
                        </div>
                        ...
                        <div class="row" id="data4">
                            <div class="col-3" style="text-align:  right" id="status1">
                            &nbsp&nbsp&nbspสถานภาพบิดา-มารดา
                            </div>
                            <div class="col-1" id="status2">
                                <input  type="checkbox" name="status_fam[]" value="อยู่ด้วยกัน" id="people_id" checked>
                            </div>
                            <div class="col-2">
                                อยู่ด้วยกัน
                            </div>
                            <div class="col-1">
                                <input  type="checkbox" name="status_fam[]" value="หย่าร้าง" id="people_id">
                            </div>
                            <div class="col-2">
                                หย่าร้าง
                            </div>
                            <div class="col-1">
                                <input  type="checkbox" name="status_fam[]" value="แยกกันอยู่"  id="people_id">
                            </div>
                            <div class="col-2">
                                แยกกันอยู่
                            </div>
                        ...
                        <div class="row" id="data4">
                            ...
                            <div class="col-1" id="status3">
                                <input  type="checkbox" name="status_fam[]" value="บิดาถึงแก่กรรม"  id="people_id">
                            </div>
                            <div class="col-2">
                                บิดาถึงแก่กรรม
                            </div>
                            <div class="col-1">
                                <input  type="checkbox" name="status_fam[]" value="มารดาถึงแก่กรรม" id="people_id">
                            </div>
                            <div class="col-2">
                                มารดาถึงแก่กรรม
                            </div>
