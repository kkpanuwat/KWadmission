...
<body>
    ...
    <div class="container">
        ...
        <br>
        <center>
            <h2>พิมพ์เอกสารสมัครเรียน</h2>
        </center>
       
        <form action="print_ad.php" method="get" id="formja">
            <div class="row" id="data4">
                ...
                <div class="col-10">
                    <br><br>
                   <input style="text-align: center;width: 100%;height: 5em ;border-radius: 1em;border: 0px solid #04808f ;background-image: linear-gradient(to left, rgb(52, 73, 94) , rgb(38, 162, 167));;color:white;font-size:1.25em" 
                   value="ตรวจสอบ" type="submit" name="" id="people_id " placeholder="กรุณากรอกรหัสประจำตัวประชาชน">
    ...
    <?php
        if(isset($_GET["msg"])){
            ...
            <br>
            <hr>
            <center><br><h3>ไม่พบเอกสารสมัครเรียนของท่าน<h3></center>
            <center>กรุณาดำเนินการส่งเอกสาร หรือ แจ้งปัญหาเกี่ยวกับการใช้งาน</center>";
            }
