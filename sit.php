...
<body>
                        ...
                        if (empty($_SESSION["username"])) {
                            ...
                            if ($_SESSION["type"] == "01") {
                                ...
                                <div style="height:80px;"></div>
                                    <div id="form_add">
                                        <form name="form1" class="form" method="post" action="sit_data.php" enctype="multipart/form-data">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col">
                                                    </div>
                                                    ...
                                                    <div class="col-8" id=row_1_1>
                                                        <input  type="file" name="file_sit" id="pro_image">
    ...
    echo '<div class="container">
    <div class="row">
        <div class="col-12"><embed src="file/sit/'.$row["sit_name"].'" mce_src="test1.pdf" width="100%" height="1000"></embed></div></div></div>'; ?>
    <br>
    <br>
    <?php
